/*
 * Stub for class sapphire.policy.explicitcaching.ExplicitCachingPolicy.ExplicitCachingServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ExplicitCachingPolicy$ExplicitCachingServerPolicy_Stub extends sapphire.policy.explicitcaching.ExplicitCachingPolicy.ExplicitCachingServerPolicy implements sapphire.kernel.common.KernelObjectStub {
    ...
    public void syncCopy(java.io.Serializable $param_Serializable_1) {
        ...
        String $__method = "public void sapphire.policy.explicitcaching.ExplicitCachingPolicy$ExplicitCachingServerPolicy.syncCopy(java.io.Serializable)";
    ...
    public sapphire.common.AppObject getCopy() {
        java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
        String $__method = "public sapphire.common.AppObject sapphire.policy.explicitcaching.ExplicitCachingPolicy$ExplicitCachingServerPolicy.getCopy()";
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        } catch (Exception e) {
