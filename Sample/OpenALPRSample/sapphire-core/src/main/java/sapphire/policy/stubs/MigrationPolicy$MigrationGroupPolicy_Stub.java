/*
 * Stub for class sapphire.policy.MigrationPolicy.MigrationGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class MigrationPolicy$MigrationGroupPolicy_Stub extends sapphire.policy.MigrationPolicy.MigrationGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public MigrationPolicy$MigrationGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        MigrationPolicy$MigrationGroupPolicy_Stub other = (MigrationPolicy$MigrationGroupPolicy_Stub) obj;
