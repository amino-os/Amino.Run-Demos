/*
 * Stub for class org.openalpr.AlprMicroService
 * Generated by MicroService Compiler (sc).
 */
package org.openalpr.stubs;


public final class AlprMicroService_Stub extends org.openalpr.AlprMicroService implements amino.run.common.AppObjectStub {

    amino.run.policy.Policy.ClientPolicy $__client = null;
    boolean $__directInvocation = false;
    amino.run.common.MicroServiceID $__microServiceId = null;

    public AlprMicroService_Stub() {
        super();
    }
    ...
    public boolean saveImage(java.lang.String $param_String_1, byte[] $param_arrayOf_byte_2, int $param_int_3) {
        ...
        try {
            if ($__directInvocation)
                ...
                String $__method = "public boolean org.openalpr.AlprMicroService.saveImage(java.lang.String,byte[],int)";
    ...
    public org.openalpr.Results recognizeImage(java.lang.String $param_String_1, java.lang.String $param_String_2, java.lang.String $param_String_3, java.lang.String $param_String_4, java.lang.String $param_String_5, int $param_int_6, org.openalpr.Configuration.ProcessEntity $param_Configuration$ProcessEntity_7) {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public org.openalpr.Results org.openalpr.AlprMicroService.recognizeImage(java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String,int,org.openalpr.Configuration$ProcessEntity)";
                $__params.add($param_String_1);
    ...
    public void migrateObject(java.net.InetSocketAddress $param_InetSocketAddress_1) {
        ...
        try {
            if ($__directInvocation)
                ...
                java.util.ArrayList<Object> $__params = new java.util.ArrayList<Object>();
                String $__method = "public void org.openalpr.AlprMicroService.migrateObject(java.net.InetSocketAddress)";
