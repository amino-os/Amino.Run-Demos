...
/**
 * Servlet implementation class RecognitionServlet
 */
@WebServlet("/RecognitionServlet")
public class RecognitionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Process p = Runtime.getRuntime().exec("python3 /home/root1/Desktop/EdgeCV/edgeCV/recognition.py");
